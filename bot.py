# ============================================================
# Complete bot.py – all fixes applied (stock increment fixed)
# ============================================================
import os
import asyncio
import logging
...
# -------- Admin OTP flows (FIXED – insert account after login) --------
async def admin_add_account_phone(update, context, phone):
    ...
    try:
        ...
        if await client.is_user_authorized():
            ...
            # Insert account if not exists (check again)
            existing = await db.db.accounts.find_one({"phone": phone})
            if not existing:
