...
# ============================================================
# FIXED: generate_payment_qr handles both Update and CallbackQuery
# ============================================================
async def generate_payment_qr(source, context, amount):
    """Generate payment QR from either Update or CallbackQuery"""
    # Determine if we have an Update or CallbackQuery
    if hasattr(source, 'effective_user'):
        # It's an Update (from message handler)
        ...
        # It's a CallbackQuery (from callback handler)
...
# ============================================================
# ADMIN PANEL (unchanged from previous) – abbreviated for space
# ============================================================
...
# ============================================================
# ADMIN CALLBACKS (full – same as previous) – abbreviated for space
# ============================================================
...
# -------- Admin Service Management (abbreviated) – same as before --------
...
# ============================================================
# MAIN – Fixed Event Loop & Shutdown
# ============================================================
async def main():
