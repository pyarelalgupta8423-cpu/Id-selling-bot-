...
async def confirm_account_purchase(query, context, service_id):
    ...
    phone = account["phone"]
    session_string = account.get("session_string")  # Now saved by admin OTP flow
...
# ============================================================
# OTP FORWARDING (FIXED – uses context to send error messages)
# ============================================================
...
# -------- Admin OTP flows (FIXED – now save session) --------
