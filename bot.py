...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "⚙️ Admin Panel" and user_id in admins:
...
# ============================================================
# SEND SERVICES AS NEW MESSAGES (from reply keyboard) – ONLY BUTTONS
# ============================================================
...
# ============================================================
# ACCOUNT SERVICES (for inline callbacks) – ONLY BUTTONS
# ============================================================
...
async def confirm_account_purchase(query, context, service_id):
    ...
    # Start OTP forwarding if session exists
    if session_string:
        asyncio.create_task(start_otp_forwarding(phone, user_id, session_string, account["_id"]))

# ============================================================
# SESSION SERVICES (for inline callbacks) – ONLY BUTTONS
# ============================================================
...
async def start_otp_forwarding(phone, user_id, session_string, account_id):
    """Connect to account and forward OTPs from Telegram service."""
    ...
    async def otp_handler(event):
        ...
        try:
            # Use the client itself to send the message (it has the bot token)
