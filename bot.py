...
# ============================================================
# SERVICE LISTING – TABLE‑STYLE CLICKABLE ROWS (Account)
# ============================================================
async def show_account_services_from_message(update, context):
    ...
    for s in current:
        ...
        country = s['name'][:18].ljust(18)
        price = f"₹{format_price(s['price'])}".ljust(8)
        stock = f"[{avail}]".ljust(6)
        row_text = f"{country}  {price}  {stock}"
...
# ============================================================
# SERVICE LISTING – TABLE‑STYLE CLICKABLE ROWS (Session)
# ============================================================
...
# ============================================================
# ACCOUNT SERVICE DETAIL – Back button fixed
# ============================================================
...
# ============================================================
# SESSION SERVICE DETAIL – Back button fixed
# ============================================================
